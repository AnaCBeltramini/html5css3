<?php
	...
	$email_destinatario = "anacfs@msn.com"; // qualquer email pode receber os dados
	$email_assunto = "Contato do site Feng Shui"; // Escrever um assunto que identifique o contato do site
